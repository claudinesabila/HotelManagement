...
public interface Hotel {
  ...
  */
  public boolean addRoom(long roomNumber, String roomType, double price, int capacity, String facilities);
  ...
  * @param vipState boolean of weather guest is a VIP or not
